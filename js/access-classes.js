...
export const FEATURE_NAV = [
  ...
  { feature_id: 'inventory',           display_name: 'Inventory',           base_folder: 'src/features/inventory',          accessible_by_classes: ['A','C'],           explicit_denials: ['B','D'] },
  { feature_id: 'time-attendance',     display_name: 'Time & Attendance',   base_folder: 'src/features/time-attendance',    accessible_by_classes: ['A','B','C','D'], explicit_denials: [] },
  { feature_id: 'leave',               display_name: 'Leave Management',    base_folder: 'src/features/leave',              accessible_by_classes: ['A','B','C','D'], explicit_denials: [] },
